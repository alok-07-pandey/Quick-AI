...
const BlogTitle = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    const title = `Exploring ${input} in the world of ${selectedCategory}`;
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        <div className='flex items-center gap-3'>
          <Sparkles className='w-6 text-[#b627c0]' />
        ...
        <button
          ...
          className='w-full flex justify-center items-center gap-2 
            bg-gradient-to-r from-[#bb1dd7] to-[#73c218] text-white px-4 py-2 mt-6
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
        <div className='flex items-center gap-3'>
          <Hash className='w-5 h-5 text-[#530e4f]' />
...

        {
          !content ? (
            ...
            <div className='flex-1 flex justify-center items-center'>
              {generatedTitle ? (
                <p className="text-base mt-6 text-gray-700">{generatedTitle}</p>
              ) : (
            ...
            <div className='mt-3 h-full overflow-y-scroll text-sm text-salte-600'>
